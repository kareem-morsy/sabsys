...
function CreateReservation() {
    ...
    useEffect(() => {
        if (searchParams.get('startDate')) {
            ...
            console.log("getHijiriDate", getHijiriDate)
            console.log("getHijiriDate1", getHijiriDate[0].format())
            console.log("getHijiriDate2", getHijiriDate[1].format())
            const calenderDates = [new DateObject(searchParams.get('startDateHijri')),
            new DateObject(searchParams.get('endDateHijri'))]
            console.log("calenderDatesFrom", calenderDates[0].format("YYYY-MM-DD"))
            console.log("calenderDatesTo", calenderDates[1].format("YYYY-MM-DD"))
