...
//         //   const [showDetailsNo, setShowDetailsNo] = useState(false);
//         const [isDisabled, setIsDisabled] = useState(false);
//         const [showGuestsPopup, setShowGuestsPopup] = useState(false);
//         const [slotIdClicked, seSlotIdClicked] = useState(0);
//         const [roomCountPopup, setRoomCountPopup] = useState([]);
//         /*End Actions State */
//         //   const handleDetails = (slot, i) => {
...
//             }
//             setRoomCountPopup(arr);
//             //map popup based count
//             //Set geusts array for this slotId
...
//         data.confirmation_no = Number(data.confirmation_no);
...
//                     <div className="col-md-3 col-12">
//                         <div className="form-group">
//                             <label htmlFor={"confirmation_no"}>Confirmation No.</label>
//                             <input
//                                 disabled={!isDisabled && "disabled"}
//                                 name={`confirmation_no`}
//                                 {...register(`confirmation_no`, {
...
//                                                                             !watch()?.slots[slotId].showDetails
//                                                                         );
//                                                                         console.log(slot.showDetails);
//                                                                     }
//                                                                     // handleDetails(slot, slotId)
//                                                                 }
//                                                             >
//                                                                 {watch()?.slots[slotId]?.showDetails ? (
//                                                                     //   showDetails && showDetailsNo === slotId ?
//                                                                     <IoIosArrowUp className="mb-1 mx-auto" />
//                                                                 ) : (
//                                                                     <IoIosArrowDown className="mb-1 mx-auto" />
//                                                                 )}
