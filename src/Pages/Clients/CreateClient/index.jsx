...
const CreateClient = () => {
  ...
  const onSubmit = (data) => {
    ...
    obj.map((item, i) => {
      postObject.append(`languages[${i}][code]`, item.code);
      postObject.append(`languages[${i}][name]`, item.name);
    });
    ...
    files?.map((file, i) => {
      postObject.append(`attachments[${i}][file]`, file);
    });

    formPost(null, "clients", postObject, true);
  };
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        <div className="row">
          ...
          <div className="col-md-12 my-5 px-4">
            ...
            <h5 className="head mt-5">Attachments</h5>
            <div
